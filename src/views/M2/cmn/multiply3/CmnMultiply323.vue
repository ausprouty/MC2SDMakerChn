...
<ul class="forward">
	...
	<li class="forward">把《雅各书》阅读一遍，把心得写下，下周小组分享。下图书卷图表仅供参考。<img src="@/assets/images/cmn/custom/image.png" /></li>
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', '恶有恶报神道兴旺——马可的出场: ', '/content/M2/cmn/multiply3/multiply323.html')">
