...
<div class="page_content" dir="ltr">
  ...
  <div  class="app-series-header">
    <img src="@/assets/images/cmn/standard/Multiply3.png" class="app-series-header" />
  </div>
  <div>
    被耶稣差派
  </div>
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Library: ', '/content/M2/cmn/multiply3/index.html')">
