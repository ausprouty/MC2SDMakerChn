...
<div class="page_content" dir="ltr">
  ...
  <div  class="app-series-header">
    <img src="@/assets/images/cmn/standard/Multiply2.png" class="app-series-header" />
  </div>
  <div>
    学象耶稣
  </div>
...
<table class="social">
	<tbody>
		<tr>
			...
			<td class="social" @click="share('lesson', 'Library: ', '/content/M2/cmn/multiply2/index.html')">
